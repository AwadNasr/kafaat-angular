...
export class ExcellencePrizeReportService {

  controllerName: String = "ExcellencePrizeReport"
  ...
  getLast(id:any): Observable<ResponseVM> {
    return this.http.get<ResponseVM>(`${environment.baseApiUrl}/${this.controllerName}/get-last/${id}`);
  }
