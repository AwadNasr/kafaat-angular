...
export class SpecializationService {
  controllerName:string = 'specialization';
  ...
  getAllByDepartmentId(id:any):Observable<ResponseVM>{
    return this.http.get<ResponseVM>(`${environment.baseApiUrl}/${this.controllerName}/get-by-department-id/${id}`);
  }
}
