...
export class VolunteeerFieldService {

  controllerName: String = "VolunteerField"
  ...
  getPageOpen(data:any):Observable<PagedResponse>{
    return this.http.post<PagedResponse>(`${environment.baseApiUrl}/${this.controllerName}/get-page-open`,data);
  }
  getPageClose(data:any):Observable<PagedResponse>{
    return this.http.post<PagedResponse>(`${environment.baseApiUrl}/${this.controllerName}/get-page-close`,data);
  }
 ...
 open(data:any):Observable<any>{
    return this.http.post<any>(`${environment.baseApiUrl}/${this.controllerName}/open-field`,data);
  }
  close(data:any):Observable<any>{
    return this.http.post<any>(`${environment.baseApiUrl}/${this.controllerName}/close-field`,data);
  }
}
