...
export class CategoryBooksService {
  ...
  controllerName: String = "Book"

  constructor(private http: HttpClient) {

  }
  add(data: any): Observable<ResponseVM> {
    return this.http.post<ResponseVM>(`${environment.baseApiUrl}/${this.controllerName}/add-book-with-qualifications`, data);
  }
  ...
  get():Observable<ResponseVM>{
    return this.http.get<ResponseVM>(`${environment.baseApiUrl}/${this.controllerName}/GetThreeBooks`);
  }
