...
export class AddPhotoComponent {
  ...
  constructor(private service: MainDashoardService,
    ...
    private route: ActivatedRoute,private PhotosService:PhotosService,
...
submit() {
  ...
  if (this.form.valid) {
    ...
    if (this.data) {
      ...
      this.PhotosService.update(formData).subscribe(res => {
      ...
      this.PhotosService.add(formData).subscribe({
