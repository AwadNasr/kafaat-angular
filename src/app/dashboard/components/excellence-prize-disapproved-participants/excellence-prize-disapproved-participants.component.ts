...
@Component({
  selector: 'app-excellence-prize-disapproved-participants',
  templateUrl: './excellence-prize-disapproved-participants.component.html',
  styleUrls: ['./excellence-prize-disapproved-participants.component.css']
})
export class ExcellencePrizeDisapprovedParticipantsComponent {
  id:any
  currentYear: string;
  navList:any[];
  ...
  getPage(id:number = 10007){
    this.pagedRequest.qualificationId=id
      this.excellencePrizeParticipantsService.getDisapprovedPageAsync(this.pagedRequest).subscribe({
        next:(res:any)=>{
