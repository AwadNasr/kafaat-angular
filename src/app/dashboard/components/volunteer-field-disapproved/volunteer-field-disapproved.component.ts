...
@Component({
  selector: 'app-volunteer-field-disapproved',
  templateUrl: './volunteer-field-disapproved.component.html',
  styleUrls: ['./volunteer-field-disapproved.component.css']
})
export class VolunteerFieldDisapprovedComponent {
  ...
  getPage(id:number = 10007){
    this.pagedRequest.qualificationId=id
      this.VolunteerFieldParticipantsService.getDisapprovedPage(this.pagedRequest).subscribe({
        next:(res:any)=>{
