...
@Component({
  selector: 'app-reading-club-trip-participants',
  templateUrl: './reading-club-trip-participants.component.html',
  styleUrls: ['./reading-club-trip-participants.component.css']
})
export class ReadingClubTripParticipantsComponent {
  id:any
