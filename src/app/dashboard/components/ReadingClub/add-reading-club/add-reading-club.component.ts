...
@Component({
  selector: 'app-add-reading-club',
  templateUrl: './add-reading-club.component.html',
  styleUrls: ['./add-reading-club.component.css']
})
export class AddReadingClubComponent {
  ...
  submit() {
    ...
    if (this.form.valid) {
      ...
      if (this.data) {
        ...
        this.service.readingClubService.update(formData).subscribe(res => {
        ...
        this.service.readingClubService.add(formData).subscribe({
